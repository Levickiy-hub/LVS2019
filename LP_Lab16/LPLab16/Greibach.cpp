...
namespace GRB
{
	Greibach greibach(NS('S'), TS('$'), 6,
		Rule(NS('S'), GRB_ERROR_SERIES + 0, 6,   //  —труктура программы
			Rule::Chain(11, TS('t'), TS('f'), TS('i'), TS('('), NS('F'), TS(')'), TS('{'), NS('N'), TS('}'), TS(';'), NS('S')),
			Rule::Chain(8, TS('t'), TS('f'), TS('i'), TS('('), NS('F'), TS(')'), TS(';'), NS('S')),
		...
		//	Rule::Chain(8, TS('t'), TS('f'), TS('s'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
		//	Rule::Chain(7, TS('t'), TS('p'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
		//	Rule::Chain(7, TS('t'), TS('e'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
		...
		Rule(NS('N'), GRB_ERROR_SERIES + 4, 9,  // возможные конструкции в ф-и€х
			...
			Rule::Chain(8, TS('d'), TS('t'), TS('p'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
			Rule::Chain(8, TS('d'), TS('t'), TS('e'), TS('('), NS('F'), TS(')'), TS(';'), NS('N')),
		...
		Rule(NS('E'), GRB_ERROR_SERIES + 2, 16, // выражени€
			Rule::Chain(1, TS('i')),
			Rule::Chain(1, TS('l')),
